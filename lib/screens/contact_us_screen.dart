            ...
            appBar: AppBar(
              ...
              title: Text(
                  context.locale == const Locale('ar')
                      ? cubit.contactModel.nameAr ?? ''
                      : cubit.contactModel.name ?? '',
                  style: TextStyle(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Text(
                                context.locale == const Locale('ar')
                                    ? cubit.contactModel.descriptionAr ?? ''
                                    : cubit.contactModel.description ?? '',
                                softWrap: true,
                              ...
                              Row(
                                ...
                                children: [
                                  cubit.contactModel.facebook != null
                                      ? InkWell(
                                          onTap: () async {
                                            if (await canLaunch(
                                                cubit.contactModel.facebook!)) {
                                              await launch(
                                                  cubit.contactModel.facebook!);
                                            } else {
                                      ...
                                      : Container(),
                                  cubit.contactModel.instagram != null
                                      ? InkWell(
                                          onTap: () async {
                                            if (await canLaunch(
                                                cubit.contactModel.facebook!)) {
                                      ...
                                      : Container(),
                                  cubit.contactModel.snapchat != null
                                      ? InkWell(
                                          onTap: () async {
                                            if (await canLaunch(
                                                cubit.contactModel.snapchat!)) {
                                              await launch(
                                                  cubit.contactModel.snapchat!);
                                            } else {
                                              throw 'Could not launch';
                                          ...
                                          child: SvgPicture.asset(
                                            'assets/images/icons8-snapchat.svg',
                                          ))
                                      : Container(),
                                  cubit.contactModel.tiktok != null
                                      ? InkWell(
                                          onTap: () async {
                                            if (await canLaunch(
                                                cubit.contactModel.tiktok!)) {
                                              await launch(
                                                  cubit.contactModel.tiktok!);
                                            } else {
                                              throw 'Could not launch';
                                      ...
                                      : Container(),
                                  cubit.contactModel.youtube != null
                                      ? InkWell(
                                          onTap: () async {
                                            if (await canLaunch(
                                                cubit.contactModel.youtube!)) {
                                              await launch(
                                                  cubit.contactModel.youtube!);
                                            } else {
                                              throw 'Could not launch';
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        if (await canLaunch(
                                            "mailto:${cubit.contactModel.email ?? ''}")) {
                                          await launch(
                                              "mailto:${cubit.contactModel.email ?? ''}");
                                        } else {
                                          throw 'Could not launch';
                              ...
                              Column(
                                children: [
                                  ...
                                  Text(
                                    LocaleKeys.contactUsMass.tr(),
                                    style: AppStyles.s18b,
                                  ),
                                  const SizedBox(
                                    height: 15,
                                  ),
                                  ...
                                  TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value!.isEmpty)
                                        return LocaleKeys.pleaseEnterSubject
                                            .tr();
                                    },
                                    decoration: InputDecoration(
                                      hintText: LocaleKeys.subjectMsg.tr(),
                                      border: InputBorder.none,
                                      filled: true,
                                      fillColor: Constant.grayColor,
                                      contentPadding:
                                  ...
                                  TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value!.isEmpty)
                                        return LocaleKeys.pleaseEnterMsg.tr();
                                    },
                                    decoration: InputDecoration(
                                      hintText: LocaleKeys.msgD.tr(),
                                      border: InputBorder.none,
                                      filled: true,
                                      fillColor: Constant.grayColor,
                                      contentPadding:
