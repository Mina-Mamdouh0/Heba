...
abstract class AppStyles {
  static const TextStyle s52 = TextStyle(
  ...
  static const TextStyle s17p = TextStyle(
    color: Constant.primaryColor,
    fontSize: 17,
    fontWeight: FontWeight.w500,
  );
  ...
  static const TextStyle s14r = TextStyle(
    color: Constant.red,
    fontSize: 14,
    fontWeight: FontWeight.w500,
  );
  static const TextStyle cW = TextStyle(
